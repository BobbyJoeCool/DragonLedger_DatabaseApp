 ...
 * (applied per-card via a `.dl-frame`/`.dl-tc-card` pseudo-element, not
 * here — this wrapper isn't card-width-constrained), Scribe's outlined
 * (vs. filled) Subcard tab, and Grimoire's print-safe light-fallback flip.
 */
